...
enum en_spi_port { DEV_SPI1_GPIOA, DEV_SPI1_GPIOB, DEV_SPI2 };
...
void dev_spi_sendCircular16(struct dev_spi *spi, uint16_t *data,
                            size_t data_len);
void dev_spi_recv16(struct dev_spi *spi, uint16_t *data, size_t data_len);
void dev_spi_recvCircular16(struct dev_spi *spi, uint8_t *data,
                            size_t data_len);
